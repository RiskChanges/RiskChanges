...
setup(
  ...
  version = '1.95',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/ashokdahal/RiskChanges/archive/0.92.tar.gz',    # I explain this later on
